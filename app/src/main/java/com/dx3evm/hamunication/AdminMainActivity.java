    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseAdapter.setOnClickListener(new CourseAdapter.OnClickListener() {
            ...
            public void onClick(int position, Course course) {
                Intent intent = new Intent(AdminMainActivity.this, EditCourseActivity.class);
        ...
        mtrlBtnAddCourse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                inputDialog.showDialog(AdminMainActivity.this, "course", new InputDialog.OnDialogClickListener() {
                    @Override
    ...
    public void createCourse(String courseName){
        ...
        newCourseRef.child("Title").setValue(courseName).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                Toast.makeText(AdminMainActivity.this, "Course added Successfully!", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(AdminMainActivity.this, "Error adding course!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}